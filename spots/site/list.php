...
<div id="main">
    ...
    <div class="d-flex flex-column">
        <fieldset class="border border-warning destaques" style="margin-bottom: 1rem">
            ...
            <div class="card mb-3 mx-auto" style="max-width: 55rem;">
            <div class="row g-0">
                <div class="col-md-5">
                ...
                <div class="col-md-7">
                    <div class="card-body">
                        ...
                        <p class="card-text"><small class="text-muted">3 mins atras</small> <a class="btn btn-info float-md-right" href="estab.php" role="button">Link</a></p>
